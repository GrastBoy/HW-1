...
console.log(prompt("Ввудіть прізвище та імя"));
console.log(prompt("Введіть адрусу доставки"));
console.log(prompt("Введіть номер телефону"));
// 1.2
// Prompt
...
console.log(prompt("Введіть прізвище та імя"));
console.log(prompt("В якому закладі ви навчаєтесь?"));
// 1.4
// Prompt и confirm
// Спитати у користувача імя та прізвище, ким працює, де працює
console.log(prompt("Введіть прізвище та імя"));
console.log(prompt("Ким ви працюєте ?"));
console.log(prompt("Місце вашої роботи "));

// 1.5
// Prompt и confirm
// Спитати у користувача імя та прізвище, адресу проживання, телефон
console.log(prompt("Введіть прізвище та імя"));
console.log(prompt("Введіть адресу проживання"));
console.log(prompt("Введіть номер телефону"));
/////////////////////////////////////////////////////////////////////////
